...
define('_ACTION_ADDED', 'تمت إضافة الإجراء');
define('_ACTION_DELETED', 'تم حذف الإجراء');
define('_ACTION_UPDATED', 'الإجراء معدل');
...
define('_INITIATOR_ENTITY', 'مرجع النظر للقائم بالطلب');
define('_DESTINATION_ENTITY', 'مرجع النظر للقائم بالطلب');
